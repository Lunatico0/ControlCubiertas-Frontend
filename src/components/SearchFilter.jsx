...
import { DEFAULT_STOCK_STATUSES } from '@constants/settingsRules.js'
...
export default SearchFilter
  ...
  //         className={`flex items-center gap-3 px-6 py-4 rounded-xl font-medium transition-all shadow-sm hover:shadow-md ${getButtonStyle(isStockActive)}`}
  //       >
  //         <span>Cubiertas en Stock</span>
  //       </button>
  //       <button
  //         onClick={handleAllTires}
  //         className={`flex items-center gap-3 px-6 py-4 rounded-xl font-medium transition-all shadow-sm hover:shadow-md ${getButtonStyle(false)}`}
  //       >
  //         <span>Todas las cubiertas</span>
  //       </button>
  //       <button
  //         onClick={handleActiveClick}
  //         className={`flex items-center gap-3 px-6 py-4 rounded-xl font-medium transition-all shadow-sm hover:shadow-md ${getButtonStyle(isCirculationActive)}`}
  //       >
  //         <span>Cubiertas en Circulación</span>
  //       </button>
  //     </div>
  ...
  //           onClick={() => setShowFilters(!showFilters)}
  //           className={`
  //           flex items-center gap-3 px-6 py-4 rounded-xl font-medium transition-all shadow-sm hover:shadow-md ${hasActiveFilters ? button.primary : `${colors.surface} ${colors.border} text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700`
  //             }
  //         `}
  //         >
  //           <span className="text-lg"><TuneRoundedIcon /></span>
